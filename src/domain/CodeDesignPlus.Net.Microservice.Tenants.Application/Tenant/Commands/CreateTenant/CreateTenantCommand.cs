...
[DtoGenerator]
public record CreateTenantCommand(Guid Id, string Name, TypeDocument TypeDocument, string NumberDocument, Uri? Domain, string Phone, Location Location, License License, bool IsActive) : IRequest;

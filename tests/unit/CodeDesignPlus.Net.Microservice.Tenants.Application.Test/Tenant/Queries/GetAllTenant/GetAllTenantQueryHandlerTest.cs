...
public class GetAllTenantQueryHandlerTest
{
    ...
    public async Task Handle_ValidRequest_ReturnsMappedTenants()
    {
        ...
        var cancellationToken = CancellationToken.None;
        var tenantAggregate = TenantAggregate.Create(Guid.NewGuid(), "TenantName", Utils.TypeDocument, "12345678", new Uri("http://example.com"), "3105682451","fake@fake.com", Utils.Location, Utils.License, true, Guid.NewGuid());
